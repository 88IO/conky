...
function disk_watch()
    ...
    disk=tonumber(conky_parse("${fs_used_perc /tmp}"))
    ...
    disk=tonumber(conky_parse("${fs_used_perc /mnt/D}"))
...
function temp_watch()
    ...
    temperature=tonumber(conky_parse("${nvidia temp}"))
...
function iface_watch()
    ...
    iface=conky_parse("${if_existing /proc/net/route wlp34s0}wlp34s0${endif}")

    settings_table[18]['arg']=iface
    settings_table[19]['arg']=iface
end
